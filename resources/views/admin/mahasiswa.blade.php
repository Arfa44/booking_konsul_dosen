...
<head>
  <meta charset="UTF-8">
  <title>Mahasiswa - Use Cash</title>
  <!-- AdminLTE CSS -->
      ...
      <div class="container-fluid">
        ...
        <div class="row mb-3">
          <div class="col-12 text-right">
            <a href="tambah_data_mahasiswa" class="btn btn-primary">
                ...
                <table class="table table-bordered table-hover text-nowrap">
                  ...
                  <tbody>
                    <tr>
                      ...
                      <td>Komputer Dan Bisnis</td>
                      <td>
                        <a href="edit_data_mahasiswa" class="btn btn-warning btn-sm">
                          <i class="fas fa-edit"></i> Edit
                        </a>
                        <a href="mahasiswa" class="btn btn-danger btn-sm" onclick="return confirm('Yakin ingin menghapus data ini?')">
                          <i class="fas fa-trash"></i> Hapus
                        </a>
                      </td>
                    </tr>
                    <!-- Data mahasiswa lainnya akan ditampilkan di sini -->
                  </tbody>
                </table>
              </div>
            </div>
